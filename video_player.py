...
class VideoPlayer(QWidget):
    ...
    def on_duration_changed(self, duration_ms):
        ...
        self.ui.videoRemainingTime.setText(f"{self._fmt(duration_ms)}")

    def on_position_changed(self, position_ms):
        self.ui.videoSlider.setValue(position_ms)
        self.ui.videoElapsedTime.setText(f"{self._fmt(position_ms)}")
    ...
    def set_timestamp_width(self):
        font_metrics = self.ui.videoElapsedTime.fontMetrics()
        fixed_width = font_metrics.horizontalAdvance("00:00:00") + 4  # +8px padding
        self.ui.videoElapsedTime.setFixedWidth(fixed_width)
        self.ui.videoRemainingTime.setFixedWidth(fixed_width)

        # Right-align elapsed, left-align duration so they hug the slider
        self.ui.videoElapsedTime.setAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        self.ui.videoRemainingTime.setAlignment(Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
